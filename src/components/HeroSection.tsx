    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 max-w-3xl mx-auto">
        ...
        <p
          ...
          ​Medival do not believe in unnecessary chemicals or exaggerated claims. Our goal is to create skincare that delivers real results while being gentle and safe.             
